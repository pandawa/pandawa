...
class StubGenerator extends Command
{
     ...
     * @return bool
     */
    protected function putFile($data)
    {
     ...
     * @return mixed
     */
    protected function getData(array $search = [], array $replace = [])
    {
     ...
     * @return mixed
     */
    protected function getRawClassName()
    {
     ...
     * @return string
     */
    protected function getNamespace($type = null)
    {
     ...
     * @return string
     */
    protected function getInclude($type = null, $className = '')
    {
